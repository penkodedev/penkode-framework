    ...
    <div class="login-container">
        ...
        <form id="loginform" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post">
            <?php if ($error_message) : ?>
                <div id="error-message" class="login-error alert alert-warning"><?php echo $error_message; ?></div>
            <?php endif; ?>

            <?php if ($login_attempts > 0) : ?>
                <div class="login-message alert alert-warning">
            ...
            <!-- REMEMBER & PASS OPTIONS begin -->
            <div class="login-options-container">
                <p class="remember-me">
                    <input name="rememberme" type="checkbox" id="rememberme" value="forever" />
                    <label for="rememberme"><?php _e('Remember Me', 'foo'); ?></label>
                </p>

                <p class="show-pass"><a href="#" onclick="togglePasswordVisibility(event)">Show Password</a></p>
                <span class="opt-sep">|</span>
                <p class="remind-pass"><a href="<?php echo home_url('/lostpassword/'); ?>">Forgot Password</a></p>
            </div>
            <!-- REMEMBER & PASS OPTIONS end -->
