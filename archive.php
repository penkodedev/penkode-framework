...
?>
    ...
    <main class="grid-main animate fadeIn" id="main-container" data-aos="zoom-in">
        ...
        <section class="post-grid">
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <div class="post-col" id="grid-col-2" data-aos="zoom-in"><!-- Choose number of columns with grid-col -->
                        <div class="grid-item">
